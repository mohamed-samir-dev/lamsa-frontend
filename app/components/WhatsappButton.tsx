...
export default function WhatsappButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white rounded-full flex items-center gap-2 px-4 py-3 shadow-lg transition-colors"
      aria-label="واتساب"
    >
