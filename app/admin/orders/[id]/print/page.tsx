...
export default function PrintOrderPage() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      let loaded = 0;
      const tryPrint = () => { if (++loaded >= images.length) doPrint(); };
      images.forEach((img) => {
  ...
  return (
    <>
      ...
      <div ref={contentRef} style={{ fontFamily: "Arial, sans-serif", padding: "10px 16px", width: "794px", position: "relative" }}>
        ...
        {company.stamp && (
          <img src={company.stamp} alt="stamp" style={{ position: "absolute", bottom: "250px", left: "20px", width: 200, opacity: 0.85, pointerEvents: "none", zIndex: 9999 }} />
        )}
          ...
          <tbody>
            <tr>
              <td style={{ padding: "6px 10px", borderRight: "2px solid black", fontSize: 11, lineHeight: 1.8, width: "50%" }}>
                ...
                <p style={{ margin: 0 }}>Thank you for shopping with {company.nameEn || "Lamsah Smart Devices"}.</p>
              ...
              <td style={{ padding: "6px 10px", fontSize: 11, lineHeight: 1.8, textAlign: "right", direction: "rtl", width: "50%" }}>
                ...
                <p style={{ margin: 0 }}>شكرا لتسوقكم من {company.nameAr || "لمسه للاجهزه الذكيه"}.</p>
